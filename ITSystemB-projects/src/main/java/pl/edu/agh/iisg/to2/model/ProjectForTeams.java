...
public class ProjectForTeams implements IProjectForTeams{
	private String id;
	private ObjectProperty<LocalDate> deadline;
	private ObjectProperty<LocalDate> startdate;
	private ObjectProperty<BigDecimal> budget;

	public ProjectForTeams(){
		this.id = UUID.randomUUID().toString();
	}
	
	public ProjectForTeams(LocalDate deadline, LocalDate startdate, BigDecimal budget) {
