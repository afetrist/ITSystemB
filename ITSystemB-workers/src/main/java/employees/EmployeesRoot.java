...
public class EmployeesRoot {
	...
	public boolean showPersonDelete(Person person){
		try{
			...
			loader.setLocation(EmployeesRoot.class.getResource("/employees/view/PersonDelete.fxml"));
    ...
    public boolean showPersonEditDialog(Person person) {
        try {
            ...
            FXMLLoader loader = new FXMLLoader();
            loader.setLocation(EmployeesRoot.class.getResource("/employees/view/PersonEditDialog.fxml"));
            AnchorPane page = (AnchorPane) loader.load();
