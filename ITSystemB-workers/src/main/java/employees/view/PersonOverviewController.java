...
import application.MainApplication; // WUT IS DAT?
...
public class PersonOverviewController {
    ...
    private ObservableList<Person> filterPeople(){
        ...
        ObservableList<Person> originalList = mainApplication.getEmployeesRoot().getPersonData();
    ...
    private void handleDeletePerson(){
        ...
        if(selectedPerson != null){
            boolean okClicked = mainApplication.getEmployeesRoot().showPersonDelete(selectedPerson);
            if(okClicked){
            	//deletePersonFromDB(selectedPerson);		//needs DB
            	mainApplication.getEmployeesRoot().deletePerson(selectedPerson);
            }
        }
        personTable.setItems(filterPeople());
    ...
    private void handleNewPerson() {
        ...
        boolean okClicked = mainApplication.getEmployeesRoot().showPersonEditDialog(newPerson);
        if (okClicked) {
            mainApplication.getEmployeesRoot().getPersonData().add(newPerson);
    ...
    private void handleEditPerson() {
        Person selectedPerson = personTable.getSelectionModel().getSelectedItem();
        if (selectedPerson != null) {
            boolean okClicked = mainApplication.getEmployeesRoot().showPersonEditDialog(selectedPerson);
            if (okClicked) {
